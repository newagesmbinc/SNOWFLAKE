...
//  Eatthos
//
//  Created by NewAgeSMB on 10/26/12.
...
- (id)initInScrollView:(UIScrollView *)scrollView activityIndicatorView:(UIView *)activity
{
    ...
    if (self) {
        ...
        //_tintColor = [UIColor purpleColor];
     //   _tintColor = [UIColor colorWithRed:71.0/255.0 green:235/255.0 blue:164/255.0 alpha:1.0];
        
        
        
        _shapeLayer = [CAShapeLayer layer];
        _shapeLayer.fillColor = [_tintColor CGColor];
        _shapeLayer.strokeColor = [[[UIColor darkTextColor] colorWithAlphaComponent:0.5] CGColor];
