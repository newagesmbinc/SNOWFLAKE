...
@interface EditPrViewController ()

@end

@implementation EditPrViewController
...
-(IBAction)selectMoun:(id)sender{
    ...
    selectmoViewController *task = [[selectmoViewController alloc]initWithNibName:@"selectmoViewController" bundle:nil];
    task.dataMount=[serverCalldata objectForKey:@"mountains_list"];
...
-(IBAction)Myacunt:(id)sender{
    
    
 EditMYACNTXIBViewController *controller = [[EditMYACNTXIBViewController alloc] initWithNibName:@"EditMYACNTXIBViewController" bundle:nil];
...
- (IBAction)editPhoto:(id)sender {
    ...
    UploadPhotoViewController *task = [[UploadPhotoViewController alloc]initWithNibName:@"UploadPhotoViewController" bundle:nil];
    task.imageArry=[appD.ServerData objectForKey:@"image_gallery"];
    [self.navigationController pushViewController:task animated:YES];
