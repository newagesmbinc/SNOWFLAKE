...
#import "EditMyAcntViewController.h"
#import "SCLAlertView.h"
#import "ARKLoader.h"
#import "ExploreViewController.h"

@interface EditMyAcntViewController ()
{
    ARKLoader *ark;
}
@end

@implementation EditMyAcntViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *gender =(UILabel *)[cell viewWithTag:1];
    gender.text=[genderArray objectAtIndex:indexPath.row];
